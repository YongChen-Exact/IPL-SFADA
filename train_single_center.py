...
parser.add_argument("--root_path", type=str,
                    default="/home/data/CY/Datasets/CenterC", help="Name of Experiment")
parser.add_argument("--source", type=str, default="CenterC", help="experiment_name")
...
if __name__ == "__main__":
    ...
    snapshot_path = "/home/data/CY/codes/BDK-SFADA/Model/{}_{}".format(
